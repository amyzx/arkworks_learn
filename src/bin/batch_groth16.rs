// This is the same with file in 
// https://github.com/arkworks-rs/ripp/blob/master/benches/examples/groth16_aggregation.rs
// Use ripp library to aggregate many groth16 proofs.
...
// Prover claim: the sum of public inputs + witness input = public sum
#[derive(Clone)]
struct TestCircuit {
    public_inputs: Vec<Fr>,
    witness_input: Fr,  // secret information
    public_sum: Fr,
}
